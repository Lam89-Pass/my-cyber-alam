...
const socials = [
  {
    label: "Instagram", href: "https://instagram.com/lam.xyz_",
  ...
  {
    label: "TikTok", href: "https://tiktok.com/@kalyn_051",
  ...
  {
    label: "LinkedIn", href: "https://linkedin.com/in/muhamadnursalam",
      ...
      <nav className="nav-wrap">
        <div className="nav-inner">
          ...
          <div className="nav-right">
            ...
            <a href="https://wa.me/6285603103375" target="_blank"
        ...
        <div className={`nav-mobile-menu${menuOpen ? " open" : ""}`}>
          ...
          <a href="https://wa.me/628603103375" target="_blank"
            rel="noopener noreferrer" className="nav-cta"
